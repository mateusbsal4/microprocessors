...
# 52 "main.c"
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "0b01111110" "," "0b00110000" "," "0b01101101" "," "0b01111001" "," "0b00110011" "," "0b01011011" "," "0b01011111" "," "0b01110000");
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "0b01111111" "," "0b01110011" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff");
...
GO_nDONE = 1;
while (GO_nDONE);
unsigned int ADC_result = ADRESH*256+ADRESL;
ADIF = 0;
