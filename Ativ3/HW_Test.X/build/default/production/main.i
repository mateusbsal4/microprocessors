...
# 18 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8/pic/include/xc.h"
...
# 7 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8/pic/include/builtins.h"
...
# 53 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8/pic/include/proc/pic16f886.h"
...
# 76 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8/pic/include/pic.h"
...
# 114 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8/pic/include/eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);

# 118 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8/pic/include/pic.h"
...
# 4 "/opt/microchip/mplabx/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8/pic/include/__size_t.h"
...
display_test_number(currentTest);
beep();
RB5 = 1;
}


if (serialIn >= '1' && serialIn <= '7') {
currentTest = serialIn - '0';
display_test_number(currentTest);
beep();
}
...
sprintf(sVar, "Bat: %d", battery_level());
...
onlyOnce = 0;
pwm_off();
nearSensorData = sensorNear_read();
sprintf(sVar, "Prox:%03d", nearSensorData);
lcd_goto(64);
lcd_puts(sVar);
break;
...
uint8_t compass_id = compass_get_id();

sprintf(sVar, "Head:%03x", compass_id);
lcd_goto(64);
lcd_puts(sVar);
break;
...
((onlyOnce) &= ~(1 << (6)));
((onlyOnce) &= ~(1 << (7)));
if (!((onlyOnce) & (1 << (currentTest)))) {
((onlyOnce) |= (1 << (currentTest)));
pwm_direction(0);
pwm_off();
delay_ms(50);
pwm_on();
