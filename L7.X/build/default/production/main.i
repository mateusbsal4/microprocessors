...
# 52 "/opt/microchip/xc8/v2.41/pic/include/proc/pic16f886.h"
...
int duty_cycle_control(){
int nearSensorData = sensorNear_read();
int upper_thresh = 480;
int dc = 0;
...
if(lineSensor.byte == 0b010){
pwm_direction(0);
led_color = (duty_cycle>480) ? (2:4);
led_rgb_set_color(led_color);
}
else if(lineSensor.byte == 0b011 || lineSensor.byte == 0b001){
pwm_direction(3);
led_color = (duty_cycle>40) ? (1:4);
led_rgb_set_color(led_color);
}
else if(lineSensor.byte == 0b110 || lineSensor.byte == 0b100){
pwm_direction(2);
led_color = (duty_cycle>40) ? (3:4);
led_rgb_set_color(led_color);
}
else if(lineSensor.byte == 0b000){
pwm_direction(3);
led_color = (duty_cycle>40) ? (6:4);
led_rgb_set_color(led_color);
}
